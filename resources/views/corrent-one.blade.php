...
<head>
    ...
    <title>YZGen | Creative Designer (Photography Specialist)</title>
                ...
                <div class="row d-flex col-md-12 col-lg-12 col-xl-12 mx-auto">
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                        <div class="list-group shadow-slideshow">
                            ...
                            <a href="{{ route('frontend.corrent-one') }}"
                                class="list-group-item list-group-item-action bg-pink text-white">Creative
                                Designer (Photography Specialist)</a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 mx-auto mt-3">
                        <div class="text-center justify-content-center">
                            ...
                            <h4>Position: Creative Designer (Photography Specialist)</h4>
                        </div>
                        <br>
                        <div>
                            <h5 class="font-bold">Position Summary</h5>
                            <br>
                            <p>A Creative Designer works and reports directly to the marketing manager. Her work is to
                                make sure a properly monthly artwork planning with creativeness and on-time delivering
                                of the artworks and the product photo-shoot in the marketing department.</p>
                            <br>
                            <h5>Duties and Responsibilities:</h5>
                            <br>
                            <ul>
                                <li>Monthly Artwork planning concept by studying social trend & company information and
                                    marketing materials</li>
                                <li>Works closely with our front line team to conduct our scheduled Product photo-shoot
                                    and perform retouching and manipulation of images.</li>
                                <li>Illustrates concept by designing rough layout of the artwork, regarding arrangement,
                                    size, type size and style, and related aesthetic concepts</li>
                                <li>Obtains approval of the concept by submitting rough layout for the artwork</li>
                                <li>Completes the projects with creativeness and on-time by coordinating with our
                                    internal team or with outside agencies, artwork services.</li>
                                <li>Maintains technical knowledge and self-improvement by attending design workshops;
                                    reviewing professional publications; participating in professional societies</li>
                                <li>Contributes to team effort by accomplishing related results as required by the
                                    manager.</li>
                                <li>Being able to film and edit videos is a plus</li>
                            </ul>
                            <br>
                            <h5>Qualifications and Requirements:</h5>
                            <br>
                            <ul>
                                <li>A degree in photo designing or a similar skill </li>
                                <li>Skillful designer with knowledge of PSD and AI; other software is a plus</li>
                                <li>At least 2 or more years of work experience in designing or marketing</li>
                                <li>Have knowledge of a marketing techniques and concepts is a plus</li>
                                <li>Be an excellent communicator, negotiator and think CREATIVELY </li>
                                <li>Work well in a team and be well presented with a professional manner </li>
                                <li>High ability to communicate in English and Khmer; others language is an advantage
                                </li>
                                <li>Be a problem solver and able to work under pressure with high responsibility</li>
                            </ul>
                        </div>
                    </div>
