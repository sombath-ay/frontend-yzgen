...
<head>
    ...
    <title>YZGen | Stock Controller</title>
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                        <div class="list-group shadow-slideshow">
                            ...
                            <a href="{{ route('frontend.corrent-one') }}"
                                class="list-group-item list-group-item-action">Creative Designer (Photography
                                Specialist)</a>
                            ...
                            <a href="{{ route('frontend.corrent-four') }}"
                                class="list-group-item list-group-item-action bg-pink text-white">Stock Controller</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-6 mx-auto mt-3">
                        <div class="text-center justify-content-center">
                            <h4>JOB DESCRIPTION</h4>
                            <h4>Position: Stock Controller</h4>
                        </div>
                        <br>
                        <div>
                            <h5 class="font-bold">Position Summary</h5>
                            <br>
                            <p>We are looking for a highly capable stock controller to manage our stock inventory. You
                                will be analyzing supply chain data to ensure stock availability, placing purchase
                                orders and transferring stock, and maintaining purchase and pricing reports.</p><br>
                            <p>To ensure success as a stock controller, you should possess extensive knowledge of
                                inventory management and experience in a related industry. An accomplished stock
                                controller will be someone whose expertise translates into optimally maintained stock
                                levels.</p>
                            <br>
                            <h5>Duties and Responsibilities:</h5>
                            <br>
                            <ul>
                                <li>Coordinating stock control operations with warehouse staff, as well as the sales and finance departments.</li>
                                <li>Analyzing supply chain data to ensure the uninterrupted availability of stock.</li>
                                <li>Placing and receiving orders to replenish stocks as needed.</li>
                                <li>Tracking shipments and coordinating internal stock transfers, as well as resolving delays.</li>
                                <li>Overseeing stock storage processes, including tagging, boxing, and labeling.</li>
                                <li>Maintaining a steady flow of stock from storage to where it is needed.</li>
                                <li>Performing regular inventory audits and keeping stock purchasing within budget.</li>
                                <li>Maintaining and updating daily shipment records, as well as purchases and pricing reports.</li>
                            </ul>
                            <br>
                            <h5>Qualifications and Requirements:</h5>
                            <br>
                            <ul>
                                <li>Proficiency in inventory management software</li>
                                <li>In-depth knowledge of inventory management principles and best practices.</li>
                                <li>Extensive experience in supply chain data analysis.</li>
                                <li>Great analytical and problem-solving skills.</li>
                                <li>Exceptional organizational and time management skills.</li>
                                <li>High school diploma and Higher</li>
                            </ul>
                        </div>
                    </div>
