...
<head>
    ...
    <title>YZGen | Graphic Designer</title>
                ...
                <div class="row d-flex col-md-12 col-lg-12 col-xl-12 mx-auto">
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                        <div class="list-group shadow-slideshow">
                            ...
                            <a href="{{ route('frontend.corrent-two') }}"
                                class="list-group-item list-group-item-action bg-pink text-white">Graphic
                                Designer</a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 mx-auto mt-3">
                        ...
                        <div>
                            ...
                            <br>
                            <p>A graphic designer works and reports directly to the marketing manager. His work is to
                                make sure the creativeness and on-time delivering the artworks in marketing department.
                                .</p>
                            <br>
                            <h5>Duties and Responsibilities:</h5>
                            <br>
                            <ul>
                                <li>Work under marketing department to produce marketing material</li>
                                <li>Plans concept by studying information and materials</li>
                                <li>Illustrates concept by designing rough layout of art and copy regarding arrangement,
                                ...
                                <li>Completes projects by coordinating with outside agencies, art services, printers,
                                    etc</li>
                                <li>Maintains technical knowledge by attending design workshops; reviewing professional
                                    publications; participating in professional societies</li>
                                <li>Contributes to team effort by accomplishing related results as needed</li>
                                <li>Being able to edit videos is a plus</li>
                            </ul>
                            <br>
